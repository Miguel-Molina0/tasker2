...
class AvaliacaoSerializer(serializers.ModelSerializer):
    ...
    def get_media_avaliacoes(self, obj):
        # Calcula a média das notas das avaliações que o prestador deste anúncio recebeu
        media = Avaliacao.objects.filter(avaliado=obj.usuario).aggregate(Avg('nr_nota'))['nr_nota__avg']
